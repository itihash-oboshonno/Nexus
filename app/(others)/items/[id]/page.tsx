        ...
        >
              ...
              <img
                ...
                onError={(e) => {
                  (e.currentTarget as HTMLImageElement).src =
                    `https://placehold.co/600x400/0f0f1a/f0a500?text=${encodeURIComponent(item.title)}`;
                }}
              />
            </div>
          </div>
          ...
          <div>
            ...
            >
              ...
              <span
                ...
                style={{
                  ...
                  border: `1px solid ${item.inStock ? "rgba(62,207,142,0.2)" : "rgba(224,85,85,0.2)"}`,
                }}
              >
                {item.inStock ? (
                  <>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (item.inStock) {
                  (e.currentTarget as HTMLElement).style.background = "#ffc033";
            ...
            {Object.entries(item.specs).map(([key, value], i) => (
              <div
                ...
                style={{
                  ...
                  padding: "16px 24px",
                  borderBottom:
                    i < Object.entries(item.specs).length - 1
